...
conn = sqlite3.connect('Prevan.db')
c = conn.cursor()
try:
        #สมัครสมาชิก
...
def loing():
        ...
        password_entry.place(x=470, y=370) 
        ...
        def booking ():
                                ...
                                if   travel_date < current_date:
                                    ...
                                    def final():
                                            ...
                                            if response>0:
                                                    ...
                                                    c.execute("INSERT INTO booking (email,fullname, location, time_slot,travel_date ,day,month,year ,status) VALUES (?,?,?, ?,?,?,?,?,?)",(show_email,location, time_slot, travel_date,day,month,year,"รอดำเนินการ",))
                                                    conn.commit()
                                                    conn.close()
                                                    ...
                                                    bookticket()
                                    info_label =Label(pay, text=f"{fullname} ",bg='#ffffff',font=("DB Helvethaica X", 15))
                ...
                fullname_entry = Entry(bookingwindow, bg="#CBCBCB", highlightthickness=0, borderwidth=0, cursor='hand2', font=("Helvetica", 17))  
                fullname_entry.place(x=330, y=160)
