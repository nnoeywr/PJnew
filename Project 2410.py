...
def loing():
        ...
        Label(loingwindow, text="อีเมล:", font=("Helvetica", 25) ,bg='#446C9E', fg="white", highlightthickness=0, borderwidth=0,).place(x=250, y=270)
        email_entry =Entry(loingwindow, bg="#196658", highlightthickness=0, borderwidth=0, cursor='hand2', font=("Helvetica", 17))  
        ...
        def repasword():##func รีเซ็ทรหัส
                ...
                Label(forgotpwwindow, text="อีเมล:", font=("Helvetica", 16) ,bg='#196658', fg="white", highlightthickness=0, borderwidth=0,).place(x=250, y=270)
                email_entry = Entry(forgotpwwindow, bg="#98D6FC", highlightthickness=0, borderwidth=0, cursor='hand2', font=("Helvetica", 17))
                email_entry.place(x=470, y=270)

                Label(forgotpwwindow, text="รหัสผ่านใหม่:", font=("Helvetica", 16) ,bg='#196658', fg="white", highlightthickness=0, borderwidth=0,).place(x=250, y=350)
                new_password_entry = Entry(forgotpwwindow, bg="#98D6FC", highlightthickness=0, borderwidth=0, cursor='hand2', font=("Helvetica", 17))
                new_password_entry.place(x=470, y=350) 
        ...
        def booking ():
                ...
                def bookticket ():
                        ...
                        if not location or not time_slot or not travel_date:
                            ...
                            if response.status_code == 200:
                                    ...
                                    close_button = tk.Button(pay, text="ชำระเงินแล้ว", command=lambda:(pay.destroy()))
                                    close_button.place(x=590,y=600)

                                    end_But= Button(pay, text="สรุป",bg='#fcdbe2', command=final,cursor="hand2",borderwidth=0, highlightthickness=0,activebackground='#fcdbe2')
                                    end_But.place(x=600, y=600)
                                    ...
                                    back_But.place(x=500, y=600)       

                            else:
                                    print("Failed to download the image. HTTP status code:", response.status_code)
                                                
                Label(bookingwindow, text="สถานที่ขึ้น-ลง:", font=("Helvetica", 16), bg='#196658', fg="white", highlightthickness=0, borderwidth=0).place(x=120, y=450)

                prices_options = [  ("ท่ารถตู้ปรับอากาศขอนแก่น-เซ็นทรัลขอนแก่น", 16),
                                    ("ท่ารถตู้ปรับอากาศขอนแก่น-แยกน้ำพอง", 92),
                                    ("ท่ารถตู้ปรับอากาศขอนแก่น-เขาสวนกวาง", 134),
                                    ("ท่ารถตู้ปรับอากาศขอนแก่น-แยกกุมภวาปี", 190),
                                    ("ท่ารถตู้ปรับอากาศขอนแก่น-เซ็นทรัลอุดรธานี(บขส1)", 249),
                ...
                location_menu.place(x=230, y=450)
                
                Label(bookingwindow, text="เวลาเดินทาง:",font=("Helvetica", 16) ,bg='#196658', fg="white", highlightthickness=0, borderwidth=0,).place(x=120, y=520)
                ...
                Label(bookingwindow, text="วันเดินทาง:", font=("Helvetica", 16), bg='#196658', fg="white", highlightthickness=0, borderwidth=0).place(x=120, y=270)
        ...
        def admin():
                ...
                edit_But= Button(admin_window,text="แก้ไขตั๋ว",bg='#e171ac',command=lambda:(edit_ticket(),admin_window.destroy()),cursor="hand2",borderwidth=0, highlightthickness=0,activebackground='#e171ac')
                edit_But.place(x=400,y=550) 
                
                delete_but = Button(admin_window,text="ลบตั๋ว", bg='#e171ac',command=lambda: (delete_ticket()),cursor="hand2",borderwidth=0, highlightthickness=0,activebackground='#e171ac')
                delete_but.place(x=500,y=550) 
        
                sum_But= Button(admin_window,text="รายได้รวมทั้งหมด",bg='#e171ac',command=lambda:(admin_window.destroy(),show_sum()),cursor="hand2",borderwidth=0, highlightthickness=0,activebackground='#e171ac')
        ...
        def edit_ticket():
                ...
                close_button = tk.Button(edit_ticket_window, text="ย้อนกลับ", command=edit_ticket_window.destroy)
        ...
        def summary():
                ...
                for booking in bookings:
                        ...
                        income = prices_options.get(location)##ดึงราคาของแพ็คเกจที่ถูกจองและเก็บไว้ในตัวแปร 
        ...
        login_But = Button(loingwindow, text="เข้าสู่ระบบ", command=lambda:(loingchecks()),font=("Helvetica", 30),  compound="center", highlightthickness=0,borderwidth=0,cursor="hand2", fg="white")
        ...
        Register_but.place(x=600,y=570)
