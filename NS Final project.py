...
def loing():
        ...
        tk.Label(loingwindow, text="อีเมล:", font=("Helvetica", 16) ,bg='#196658', fg="white", highlightthickness=0, borderwidth=0,).place(x=250, y=270)
        ...
        tk.Label(loingwindow, text="รหัสผ่าน:", font=("Helvetica", 16) ,bg='#196658', fg="white", highlightthickness=0, borderwidth=0,).place(x=250, y=350)
        ...
        def admin():
                ...
                sum_But= Button(admin_window,bg='#e171ac',command=lambda:(admin_window.destroy(),show_sum()),cursor="hand2",borderwidth=0, highlightthickness=0,activebackground='#e171ac')
        ...
        def show_sum():
                ...
                tree = ttk.Treeview(frame, columns=("place", "travel_date", "time_slot", "status"))
...
login_button = Button(root, text='Login', bg='#e171ac',fg='white', font=45, command=loing,borderwidth=0, highlightthickness=0,cursor="hand2",activebackground='#e171ac')
