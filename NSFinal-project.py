...
def Register():
        ...
        Label(Regitwindow, text="ชื่อจริง:", font=("Helvetica", 16) ,bg='#196658', fg="white", highlightthickness=0, borderwidth=0,).place(x=120, y=110)
        fname_entry = Entry(Regitwindow, bg="#98D6FC", highlightthickness=0, borderwidth=0, cursor='hand2', font=("Helvetica", 17))  
        fname_entry.place(x=225, y=115)

        Label(Regitwindow, text="นามสกุล:",font=("Helvetica", 16) ,bg='#196658', fg="white", highlightthickness=0, borderwidth=0,).place(x=120, y=150)
        lname_entry = Entry(Regitwindow, bg="#98D6FC", highlightthickness=0, borderwidth=0, cursor='hand2', font=("Helvetica", 17))
        lname_entry.place(x=225, y=155)

        Label(Regitwindow, text="เบอร์โทรศัพท์:",font=("Helvetica", 16) ,bg='#196658', fg="white", highlightthickness=0, borderwidth=0,).place(x=115, y=190)
        phone_entry = Entry(Regitwindow, bg="#98D6FC", highlightthickness=0, borderwidth=0, cursor='hand2', font=("Helvetica", 17))
        phone_entry.place(x=225, y=195)

        Label(Regitwindow, text="อีเมล:",font=("Helvetica", 16) ,bg='#196658', fg="white", highlightthickness=0, borderwidth=0,).place(x=120, y=230)
        email_entry = Entry(Regitwindow, bg="#98D6FC", highlightthickness=0, borderwidth=0, cursor='hand2', font=("Helvetica", 17))
        email_entry.place(x=225, y=235)

        Label(Regitwindow, text="รหัสผ่าน:",font=("Helvetica", 16) ,bg='#196658', fg="white", highlightthickness=0, borderwidth=0,).place(x=125, y=270)
        password_entry = Entry(Regitwindow, bg="#98D6FC", highlightthickness=0, borderwidth=0, cursor='hand2', font=("Helvetica", 17))
...
def loing():
        ...
        Label(loingwindow, text="อีเมล:", font=("Helvetica", 16) ,bg='#196658', fg="white", highlightthickness=0, borderwidth=0,).place(x=250, y=270)
        email_entry =Entry(loingwindow, bg="#98D6FC", highlightthickness=0, borderwidth=0, cursor='hand2', font=("Helvetica", 17))  
        email_entry.place(x=470, y=270)

        Label(loingwindow, text="รหัสผ่าน:", font=("Helvetica", 16) ,bg='#196658', fg="white", highlightthickness=0, borderwidth=0,).place(x=250, y=350)
        password_entry = Entry(loingwindow, bg="#98D6FC", highlightthickness=0, borderwidth=0, cursor='hand2', font=("Helvetica", 17))  
        password_entry.place(x=470, y=350) 

        result_label = Label(loingwindow, text="",bg='#fcdbe2',fg='black',font=("DB Helvethaica X", 10))
        result_label.place(x=470,y=400)
        ...
        def repasword():##func รีเซ็ทรหัส
                ...
                email_entry = Entry(forgotpwwindow,text="อีเมล:",width=25,font=("DB Helvethaica X", 10),borderwidth=0, highlightthickness=0,cursor="hand2")
                email_entry.place(x=175,y=70)
                password_entry = Entry(forgotpwwindow,text="รหัสผ่านใหม่:",show='*',width=25,font=("DB Helvethaica X", 10),borderwidth=0, highlightthickness=0,cursor="hand2")
                ...
                resetpass_But= Button(forgotpwwindow,text="เปลี่ยนรหัสผ่าน:",bg='#fcd9e2',fg='black',command=changePassword,cursor="hand2", font=("DB Helvethaica X", 10),borderwidth=0, highlightthickness=0,activebackground='#fcd9e2')
                resetpass_But.place(x=150,y=240)
                
                back2_But= Button(forgotpwwindow,text="ย้อนกลับ:",bg='#fcd9e2',fg='black',command=lambda:(forgotpwwindow.destroy(),loing()),cursor="hand2", font=("DB Helvethaica X", 10),borderwidth=0, highlightthickness=0,activebackground='#fcd9e2')
        ...
        def booking ():
                ...
                def bookticket ():
                        ...
                        if not place or not time_slot or not selected_date:
                                ...
                                if   selected_date < current_date:
                                        ...
                                        price=prices.get(update_selected_price,0)
                                        ...
                                        if response.status_code == 200:
                                                ...
                                                p_button = Button(pay, text="ชำระเงินแล้ว", command=lambda:(final()))
                                                p_button.place(x=570,y=600)

                                                close_button = Button(pay, text="ย้อนกลับ", command=lambda:(pay.destroy()))
                ...
                # confirm_But= Button(bookingwindow,text='ยืนยันการจอง',bg='#fcdce2',fg='black',command=lambda:(bookticket()),cursor="hand2",borderwidth=0, highlightthickness=0,activebackground='#fcdce2')
                ...
                # back_But= Button(bookingwindow,bg='#fcdce2',text='ย้อนกลับ',fg='black',command=lambda:(bookingwindow.destroy(),Place()),cursor="hand2",borderwidth=0, highlightthickness=0,activebackground='#fcdce2')
                ...
                #ปุ่มยืนยัน
                confirm_But= Button(bookingwindow,text='บันทึก',bg='#fcdce2',fg='black',command=lambda:(bookticket()),cursor="hand2",borderwidth=0, highlightthickness=0,activebackground='#fcdce2')
                confirm_But.place(x=600, y=400)
        ...
        login_But = Button(loingwindow, text="เข้าสู่ระบบ", command=lambda:(loingchecks(),loingwindow.destroy()),font=("Helvetica", 30),  compound="center", highlightthickness=0,borderwidth=0,cursor="hand2", fg="white")
        login_But.place(x=420,y=460)     

        Register_but = Button(loingwindow, text="สมัครสมาชิก",bg="#ffffff",command=Register,cursor="hand2",borderwidth=0, highlightthickness=0,activebackground='#ffffff' )
        Register_but.place(x=380,y=560)
...
# background_image = tk.PhotoImage(file=r"c:\Users\noeyw\Downloads\1.png")
# background_label = tk.Label(root, image=background_image)
# background_label.place(relwidth=1, relheight=1)
# background_label.pack()

login_button = Button(root, text='Login', bg='#e171ac',fg='black', font=45, command=loing,borderwidth=0, highlightthickness=0,cursor="hand2",activebackground='#e171ac')
login_button.config(font=("DB Helvethaica X", 12,'bold'))
login_button.place(x=515, y=570)
